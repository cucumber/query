...
class CucumberQuery(ConanFile):
    ...
    description = "Cucumber Query for C++"
    topics = ("cucumber", "query", "bdd", "json")
    ...
    def generate(self):
        ...
        cmake_toolchain.cache_variables["CUCUMBER_QUERY_BUILD_TESTS"] = self._build_tests()
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "cucumber_query")
        self.cpp_info.set_property("cmake_target_name", "cucumber::query")
        self.cpp_info.libs = ["cucumber_query"]
