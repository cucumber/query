...
1. Add the method in `java/**/query/Query.java` with test(s) in `java/**/query/QueryTest.java`
2. Extend `java/**/query/QueryAcceptanceTest.java` to include verifications for the new
   method
